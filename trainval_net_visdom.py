...
def parse_args():
    ...
    parser.add_argument('--save_dir', dest='save_dir',
                        help='directory to save models', default="/home/toyota/download/FPN_Pytorch-master/weights", )
...
if __name__ == '__main__':
    ...
    if args.dataset == "pascal_voc":
        ...
        args.set_cfgs = ['FPN_ANCHOR_SCALES', '[32, 64, 128, 256, 512]', 'FPN_FEAT_STRIDES', '[4, 8, 16, 32, 64]',
                         'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "pascal_voc_0719":
        args.imdb_name = "voc_2007_trainval+voc_2019_trainval"
        args.imdbval_name = "voc_2007_trainval+voc_2019_trainval"
        args.set_cfgs = ['FPN_ANCHOR_SCALES', '[32, 64, 128, 256, 512]', 'FPN_FEAT_STRIDES', '[4, 8, 16, 32, 64]',
                         'MAX_NUM_GT_BOXES', '20']  
    elif args.dataset == "pascal_voc_0819":
        args.imdb_name = "voc_2008_trainval+voc_2019_trainval"
        args.imdbval_name = "voc_2008_trainval+voc_2019_trainval"
        args.set_cfgs = ['FPN_ANCHOR_SCALES', '[32, 64, 128, 256, 512]', 'FPN_FEAT_STRIDES', '[4, 8, 16, 32, 64]',
                         'MAX_NUM_GT_BOXES', '20']                                                 
    ...
    # visdom
    featurename= 'fpn-adfrd-kitti2'
    visname=args.dataset+'-'+args.net+'-'+featurename+'-'+'loss'
    vis = Visualizer(env=visname)  # 为了可视化增加的内容
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        for step in range(iters_per_epoch):
            ...
            if step % args.disp_interval == 0:
                ...
                vis.plot_many_stack({'train_loss': loss_meter.value()[0],'rpn_cls_loss': loss_rpn_cls_meter.value()[0],'rpn_bbox_loss': loss_rpn_box_meter.value()[0],'rcnn_cls_loss': loss_rcnn_cls_meter.value()[0],'rcnn_box_loss': loss_rcnn_box_meter.value()[0]})
